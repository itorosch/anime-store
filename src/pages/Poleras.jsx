...
function Poleras() {
  ...
  const polerasFiltradas = poleras.filter(p =>
      ...
      <nav className="navegador">
        ...
        <div className="d-none d-xl-block">
          <div className="list-group rounded-3">
            ...
            <Link className="list-group-item list-group-item-action active" to="/poleras">Poleras</Link>
        ...
        <div className="d-none d-md-block d-xl-none">
          <div className="bg-dark rounded-3 px-3 py-2">
            <ul className="nav justify-content-center">
              ...
              <li className="nav-item">
                <Link className="nav-link text-white fw-semibold" to="/poleras">Poleras</Link>
              </li>
              <li className="nav-item">
